...
export class AdminFunctionsComponent {
  ...
  createAdmin(input:any){
    console.warn(input);
    this.adminFuncService.createAdmin(input).subscribe((result: any)=>{
      alert(result);
    })
  }
  ...
  deleteAdmin(input:any){
    console.warn(input);
    this.adminFuncService.deleteAdmin(input).subscribe((result: any) =>{
      alert(result);
    })
  }
  ...
  viewAdmin(input:any){
    console.warn(input);
    this.adminFuncService.viewAdmin(input).subscribe((result: any)=>{
      console.log(result);
  ...
  viewAllAdmin(){
    this.adminFuncService.viewAllAdmin().subscribe((result: any) =>{
      console.log(result);
